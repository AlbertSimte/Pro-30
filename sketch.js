...
function setup() {
    ...
    groundG= new Ground(640,250,220,20)
    groundG2= new Ground(330,450,250,20)
  ...
  block23=new Block(640,195,30,30)
    ...
    chain=new Chain(poly,{x:150,y:200})
...
function draw() {
  ...
  chain.display()
    ...
    imageMode(CENTER)
    image(poly_image,poly.position.x,poly.position.y,40,40)
